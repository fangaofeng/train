...
import { DatePicker , Card , Button , Input , Form , message } from 'antd';
...
class EditSP extends Component {
    ...
    getInfo = () => {
      ...
      dispatch({
        type: 'StudyPlanManager/EditGetCourseAndPlanInfo',
        payload: {
          id:studyPlanID,// id
        },
        callback: (res)=>{
          ...
          <PageHeaderWrapper title={pageHeaderWrapperTitle()}>
            ...
            >
              ...
              <div className={styles.foonter_btns}>
                <Button type="primary" onClick={this.editSubmit}>提交</Button>
