...
export default () => {
  const datalist = state => state.ArticleManager.articleList;
  ...
  const props = {
    listAction: 'ArticleManager/GetArticleLists',
    name: '公告',
    datalist,
    columns,
    changestatusAction: 'ArticleManager/ChangeArticleStatus',
    delAction: 'ArticleManager/DelArticle',
  };
